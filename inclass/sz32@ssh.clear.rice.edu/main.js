...
function selectiveFilter(){	
	return function(cards, keys){
		...
		var output = [];
		// console.log("1st: searchKeyword:", keys);
		var searchKeyword = keys.toLowerCase();

		angular.forEach(cards, function(card){
			// console.log("2nd: searchKeyword:", searchKeyword);
			// console.log("inner-loop: card.poster:",card.poster);
			// console.log("inner-loop: card.poster.match(searchKeyword):",card.poster.match(searchKeyword) !== null);
		...
		// return cards.match(searchKeyword);
		// return cards.filter(function(card){return card.poster.match(MainPageCtrl.searchKeyword)});
	// };
